...
class GollumDeveloper(QtGui.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        settingsLayout.addWidget(self.minAreaLabel, 4, 0)
        ...
        settingsLayout.addWidget(corrThresLabel, 13, 0)
        settingsLayout.addWidget(self.corrThresEdit, 13, 1)
        settingsLayout.addWidget(advButton, 14, 0, 1, 2)
        settingsLayout.addWidget(corrButton, 15, 0, 1, 2)
        settingsLayout.addWidget(self.resultLabel, 16, 0, 2, 0)
